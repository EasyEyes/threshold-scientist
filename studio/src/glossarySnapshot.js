...
// Glossary version: 28.0
// Parameters: 603 · Super-matching params: 2
// Source: https://easyeyes.app/.netlify/functions/glossary
// Generated: 2026-08-28T04:34:35.048Z

export const glossaryVersion = "28.0";

export const superMatchingParams = ["questionAndAnswer@@", "questionAnswer@@"];
...
export const glossary = {
  ...
  _about: {
    name: "_about",
    availability: "Effect of font on crowding.",
    type: "text",
    default: "",
    explanation:
      "_about (no default) is an optional, brief description of the whole study. Ignored by EasyEyes, but saved with results.\n\nThe leading underscore in the parameter name indicates that one value (provided in column B) applies to the whole study. Underscore-parameter rows must be blank in columns C on.",
  ...
  _authorEmails: {
    name: "_authorEmails",
    availability: "dp3@nyu.edu",
    type: "text",
    default: "",
    explanation:
      "_authorEmails (no default) is optional, semicolon-separated email addresses of the authors.  The leading underscore in the parameter name indicates that one value (provided in column B) applies to the whole study. Underscore-parameter rows must be blank in columns C on. ",
    example: "dp3@nyu.edu",
  },
  _authors: {
    name: "_authors",
    availability: "Denis Pelli",
    type: "text",
    default: "",
    explanation:
      "_author (no default) is optional, the names of all the authors, separated by semicolons. The leading underscore in the parameter name indicates that one value (provided in column B) applies to the whole study. Underscore-parameter rows must be blank in columns C on.",
    example: "Denis Pelli",
  },
  _calibrateDistance: {
  ...
  _calibrateDistanceCameraHz: {
    ...
    availability: "_calibrateDistanceCameraResolution",
    type: "numerical",
    default: "15",
    explanation:
  ...
  _calibrateDistanceCameraToBlueLineCm: {
    ...
    availability: "_calibrateDistanceCameraToCardCm",
    type: "numerical",
    default: "2",
    explanation:
  ...
  _calibrateDistanceCardTopVideoFraction: {
    ...
    availability: "_calibrateTrackDistanceCardTopVideoFraction",
    type: "numerical",
    default: "0.75",
    explanation:
  ...
  _calibrateDistanceCropOutTube: {
    name: "_calibrateDistanceCropOutTube",
    availability: "",
    type: "categorical",
    default: "dontCrop",
    explanation:
      "🕑 _calibrateDistanceCropOutTube (default: dontCrop). During distance calibration with the paper tube, this controls whether the paper tube is cropped out of the video fed to Google FaceMesh and shown to the participant. Once the tube no longer overlaps the face, EasyEyes can help the participant remove the tube from the video analyzed by Google FaceMesh by trimming the video to exclude the tube.\n\n• dontCrop: No cropping.\n\n• crop: Excludes the tube whenever it's entirely off the face. The cropped view is fed to Google FaceMesh and shown on the screen to the participant. This is recommended for participants so they can simply be instructed to move the tube out of the displayed video.\n\n• cropButShowWhole: Crop what Google FaceMesh sees, but display the entire camera frame on screen to the participant. The region not passed to FaceMesh is shown slightly dimmed. This is for debugging.",
    example: "",
    categories: ["dontCrop", "crop", "cropButShowWhole"],
  },
  ...
  _calibrateDistanceObjectMinMaxCm: {
    ...
    availability: "calibrateDistanceObjectMinCm",
    type: "numerical",
    default: "40, 70",
    explanation:
  ...
  _calibrateDistancePupil: {
    ...
    availability: "calibrateDistanceIris",
    type: "categorical",
    default: "eyeCorners",
    explanation:
  ...
  _calibrateSoundBurstLevelReTBool: {
    ...
    default: "FALSE",
    explanation:
      "⚠️ WORKS BUT NOT RECOMMENDED. _calibrateSoundBurstLevelReTBool (default FALSE) when TRUE the burst sound level is \n_calibrateSoundBurstDb+(T - soundGainDbSPL), \nwhere T is the output threshold in the dynamic range compression model and T-soundGainDbSPL is the input threshold. When FALSE the burst sound level is _calibrateSoundBurstDb. ",
    example: "",
  },
  ...
  _dateCreated: {
    name: "_dateCreated",
    availability: "8/1/2021",
    type: "text",
    default: " ",
    explanation:
      "_dateCreated (no default) is the optional date of creation. The leading underscore in the parameter name indicates that one value (provided in column B) applies to the whole study. Underscore-parameter rows must be blank in columns C on.",
    example: "8/1/2021",
  },
  _dateModified: {
    name: "_dateModified",
    availability: "8/15/2021",
    type: "text",
    default: " ",
    explanation:
      "_dateModified (no default) is the optional date of latest modification. The leading underscore in the parameter name indicates that one value (provided in column B) applies to the whole study. Underscore-parameter rows must be blank in columns C on.",
    example: "8/15/2021",
  },
  _debriefForm: {
    name: "_debriefForm",
    availability: "debrief2021.pdf",
    type: "text",
    default: "",
    explanation:
      "⭑ _debriefForm is the file name of your PDF (or plain-text Markdown with extension MD) debrief document in the folder EasyEyesResources/forms/ in your Pavlovia account. The EasyEyes.app/threshold page makes it easy to upload your debrief form(s) to that folder. The compiler will check that a file with this name is present in your EasyEyesResources/ConsentForms folder on Pavlovia. See consent in Glossary for information about testing minors and children. The leading underscore in the parameter name indicates that one value (provided in column B) applies to the whole study. Underscore-parameter rows must be blank in columns C on.",
  ...
  _invitePartingCommentsBool: {
    ...
    default: "FALSE",
    explanation:
      "🕑 _invitePartingCommentsBool. At the end of the study, invite the participant to make parting comments. The leading underscore in the parameter name indicates that one value (provided in column B) applies to the whole study. Underscore-parameter rows must be blank in columns C on.",
    example: "TRUE",
  },
  ...
  _language: {
    ...
    default: "en",
    explanation:
      '_language (default "en") uses the BCP 47 standard (e.g. "en" for English, "en-US" for American English) to specify the language initially used for instructions. All translation is done by DeepL, with some manual overrides, in three places:\n1. on the EasyEyes Google sheet for International Phrases:\nhttps://docs.google.com/spreadsheets/d/e/2PACX-1vRYca5lLyfoYjgL1aVktCftp9GCebMGuqELWCZ4lFYFQb0etqzRrQ1a51Bzhqo-YOJ4fduHq6wWhVtv/pubhtml\nThe translations of International Phrases by DeepL (cyan background) are good, but not perfect, so in some cases we pasted in better translations for key phrases (non-cyan background prevents overwriting by DeepL). \n2. on the spreadsheet named by _languagePhrasesSpreadsheet.\n3. on the spreadsheet named by _phrasesSpreadsheet.\n\nThe scientist uses _language to set the initial language.  If _languageSelectionByParticipantBool===TRUE then the Title and Device Compatibility pages will allow the participant to choose any language for the rest of the study. Otherwise the language remains as set by _language.\n\nThe BCP 47 standard specifies a two-or-three-letter code for each language, e.g. en for English, ar for Arabic, and fa for Farsi/Persian. That can be extended by hyphenated suffixs to be more specific, e.g. en-US and en-GB. \n\nIMPORTANT LIMITATION: _languagePhrasesSpreadsheet works with _language, but it ignores _languageSelectionByParticipantBool. (Our compile-time implementation of _languagePhrasesSpreadsheet supports _language. Extending it to support _languageSelectionByParticipantBool would require switching to a runtime implementation. That would be a big effort for what we estimate to be a rare and noncritical use case.) The compiler allows you to enable both _languagePhrasesSpreadsheet and _languageSelectionByParticipantBool because the combination, though limited, might still be useful.\n\n42 LANGUAGES\n42 languages (below) are currently accepted. They include the main european languages and every language with at least 100 million speakers worldwide, based on Ethnologue’s estimates of total first- and second-language speakers. We\'ll add more as needed. Write to denis.pelli@nyu.edu with SUBJECT: EasyEyes.\nhttps://developer.mozilla.org/en-US/docs/Glossary/BCP_47_language_tag\nArabic:                ar\nBengali:               bn\nChinese (Simplified):  zh-Hans\nChinese (Traditional): zh-Hant\nCzech:                 cs\nDanish:                da\nDutch:                 nl\nEnglish:               en\nFilipino:              fil\nFinnish:               fi\nFrench:                fr\nGerman:                de\nGreek:                 el\nHausa (Latin):         ha-Latn               \nHebrew:                he\nHindi:                 hi\nHungarian:             hu\nIndonesian:            id\nItalian:               it\nJapanese:              ja\nJavanese:              jv\nKorean:                ko\nMalay:                 ms\nMarathi:               mr\nNigerian Pidgin:       pcm\nNorwegian:             no\nPersian:               fa\nPolish:                pl\nPortuguese:            pt\nPunjabi:               pa\nRomanian:              ro\nRussian:               ru\nSpanish:               es\nSwahili:               sw\nSwedish:               sv\nTamil:                 ta\nTelugu:                te\nThai:                  th\nTurkish:               tr\nUkrainian:             uk\nUrdu:                  ur\nVietnamese:            vi',
    example: "",
    categories: [
      "en",
      "ar",
  ...
  _languagePhrasesSpreadsheet: {
    name: "_languagePhrasesSpreadsheet",
    availability: "",
    type: "text",
    default: "",
    explanation:
      "_languagePhrasesSpreadsheet (default: empty) specifies the name of a spreadsheet containing language-specific phrases. The filename must end in .phrases.xlsx, for example, Compare3Languages.phrases.xlsx.\nColumn A contains symbolic phrase names. Column B contains the source phrases, typically—but not necessarily—in English. Each subsequent column contains translations into a different language. The first row of each language column must contain its language code, such as en for English or ar for Arabic. A phrase is selected by its symbolic name (row) and _language (column).\nDeepL automatically translates each white-background cell in columns C and beyond, using the corresponding phrase in column B as the source. Cells with a non-white background are treated as manually authored and are not automatically modified. Text color has no effect.\n\nSUPPORT FOR EXPORT ARCHIVES. As with other resources, when you export your study, any _languagePhrasesSpreadsheet spreadsheet is included in the *.export.zip archive. Conversely, when you compile an export archive, the compiler will use any _languagePhrasesSpreadsheet spreadsheet that it finds in the archive.\n\nEXPORT TO EXAMINE THE TRANSLATED PHRASES. The scientist submitted a language phrases sheet to the EasyEyes compiler, which translates it and saves it as a resource in the scientist's Pavlovia account. To examine it, choose a study that uses that resource, and use the compiler's Export button. The export.zip includes all resources needed by the study, including the TRANSLATED version of the language phrases spreadsheet.\n\nIMPORTANT LIMITATION: _languagePhrasesSpreadsheet works with _language, but ignores _languageSelectionByParticipantBool. (Our compile-time implementation of _languagePhrasesSpreadsheet supports _language. Extending it to support _languageSelectionByParticipantBool would require a runtime implementation. That would be a big effort for what we estimate to be a rare and optional use case.) The compiler allows you to enable both _languagePhrasesSpreadsheet and _languageSelectionByParticipantBool because the combination, though limited, might still be useful.\n\nThe scientist can specify a symbolic name preceded by ~ for any parameter value in the EasyEyes study spreadsheet. This requests that ~xyz be replaced by a lookup of xyz in first column of the spreadsheet specified by _languagePhrasesSpreadsheet, using the row whose first cell matches the symbolic name (without the ~), and using the column specified by _language., unless the it's overriden by the participant when _languageSelectionByParticipantBool=TRUE.\n\nThe first three rows of the language phrases spreadsheet are\nLanguageCode: the short 2+ letter code\nLanguageEnglishName: what the language is called in English\nLanguageNativeName: what the language is called in the language itself\nColumn 2, the master column, can be any language. Cells in columns 2+ with a white background are translated by DeepL from column 2. \nThe study spreadsheet can use the symbolic phrases created by the scientist plus those at the top of the spreadsheet:\n~LanguageCode\n~LanguageEnglishName\n~LanguageNativeName",
    example: "",
  },
  ...
  _logParticipantsBool: {
    ...
    default: "FALSE",
    explanation:
      "⚠️️ _logParticipantsBool (default FALSE), when TRUE, record each participant in the FormSpree server. The data saved there survive a crash of the session. We use this to investigate discrepancies between the number of studies reported by Prolific and Pavlovia.  The results are automatically included by Shiny, so it effortlessly makes the Shiny display more complete. \n⚠️️ Our contract with FormSpree entitles us to only 20,000 log entries per month, including all EasyEyes users. This limit is easily exceeded, so please only use _logParticipantsBool when you need it.\n⚠️️ We suspect that _logFontBool and/or _logParticipantBool may add 0.2 s to 1 s to the target duration. Check pilot data before enabling this during serious data collection.\n\nAlso see _logFontBool.",
    example: "",
  },
  _logTrialsBool: {
    name: "_logTrialsBool",
  ...
  _needOperatingSystem: {
    ...
    default: "all",
    explanation:
      "⭑ _needOperatingSystem (default all) is a comma-separated list either of compatible or incompatible operating systems. The list can be 'all', or compatible OSes by name, or incompatible OSes each preceded by \"not\". No mixing allowed. The default is 'all'. If compatible, then anything not listed is deemed incompatible. If incompatible, then anything not listed is deemed compatible. If not compatible, the Device Compatibility page rejects by issuing a fatal explanatory error message to the participant (asking Prolific participants to \"return\" this study), which ends the session before asking for consent. After compiling your study, copy the Device Compatibility statement from the EasyEyes compiler page into your _online2Description to satisfy Prolific's rule that all Device Compatibility requirements be declared in the study's Description.",
  ...
  _needScreenSizeMinimumPx: {
    ...
    default: "",
    explanation:
      '🕑 _needScreenSizeMinimumPx is just a placeholder in this Glossary. Any attempt to use it in your study will be rejected by the compiler as "obsolete". In each block, needScreenHeightDeg and needScreenWidthDeg are each combined with needTargetAsSmallAsDeg to compute a needed screen resolution, which is enforced in the initial Device Compatibility page. ',
    example: "",
  },
  ...
  _needSmartphoneTooBool: {
    ...
    default: "FALSE",
    explanation:
      "🕑 If TRUE, _needSmartphoneTooBool (default FALSE) asks the participant if, in addition to whatever device is running the study, they have a smartphone available for use by EasyEyes (either for sound calibration or remote keypad). EasyEyes just asks, without verifying. Verification will happen later, when the QR code is shown to recruit the smartphone. \n[We have not yet considered, in the case of an study running on a smartphone, whether we could use its built-in mic to calibrate its loudspeaker, eliminating the need for a second device.] \nAfter compiling your study, copy the Device Compatibility statement from the Compiler page into your _online2Description to satisfy Prolific's rule that all Device Compatibility requirements be declared in the study's Description.",
    example: "TRUE",
  },
  _needSoundOutput: {
    ...
    explanation:
      '🕑 _needSoundOutput (default speakerOrHeadphone) specifies the needed kind of sound output:\nspeaker\nheadphone\nspeakerOrHeadphone\nspeakerAndHeadphone NOT YET IMPLEMENTED\nnone NOT YET IMPLEMENTED\nIt complements needSoundOutput, which is for blocks, to allow the scientist to indicate whether setting up for the study (e.g. sound calibration) requires either headphones (including earbuds) or speakers. Think of the processing before block 1 as "block 0". Set _needSoundOutput for block 0 in the same way that you set needSoundOutput for other blocks. \nSee needSoundOutput.',
    example: "",
    categories: [
      "speaker",
      "headphone",
  ...
  _online1InternalName: {
    ...
    default: "",
    explanation:
      '_online1InternalName [Prolific "Give your study an internal name (only visible to you)"] (default is beginning of your study URL: net id and study name) specifies the internal name, as a text string, instead of letting Prolific assign it from your study URL. ',
    example: "",
  },
  _online1RecruitmentService: {
    name: "_online1RecruitmentService",
    availability: "Prolific",
    type: "categorical",
    default: "none",
    explanation:
      "⭑ _online1RecruitmentService (default none). Name of recruitment service: Prolific, SONA, MTurk.  The key idea is two URLs that carry parameters. The Study URL (a link to our study) carries parameters provided by the recruitment service (e.g. Prolific). The Completion URL (a link to the completion page of the recruitment service) carries the completion code certifying that the participant completed the study. \nnone - Just produce a study URL.\nProlific - integrate with Prolific, which is suggested by the PsychoPy manual. https://www.psychopy.org/online/prolificIntegration.html\nNOT YET IMPLEMENTED: MTurk\nNOT YET IMPLEMENTED: SONA",
    example: "Prolific",
    categories: ["none", "Prolific"],
  },
  _online1Title: {
    name: "_online1Title",
    availability: "Vision test",
    type: "text",
  ...
  _online2Pay: {
    ...
    default: "0",
    explanation:
      '_online2Pay [Prolific "How much do you want to pay them?"] TYPICALLY YOU SHOULD USE _online2PayPerHour INSTEAD BECAUSE THAT\'S WHAT PARTICIPANTS CARE ABOUT MOST. _online2Pay (default zero) specifies the payment (a number) to offer to each participant. The currency is specified by _online2PayCurrencyCode.  If _online2Pay and _online2PayPerHour are both nonzero, then the participant is offered the sum of the two contributions.  In deciding whether to participate, potential participants mainly consider _online2PayPerHour, _online0Title, _online2Description, and _online2Minutes. Some participants mentioned selecting my study because it seemed interesting. Others said that in their rush to sign up for a $15+/hour study, they often skip the description. \n\nA statement of payment to the participant appears below the consent form. The amount is _online2Pay plus the product of expected duration _online2Minutes / 60 and pay per hour _online2PayPerHour. That number is followed by _online2PayCurrencyCode as the unit of currency. For example "15.00 USD". Use _online2PayShow to control what\'s shown.',
    example: "7.5",
  },
  _online2PayCurrency: {
    ...
    type: "obsolete",
    default: "",
    explanation: "❌ Use _online2PayCurrencyCode instead.",
    example: "GBP",
  },
  _online2PayCurrencyCode: {
    name: "_online2PayCurrencyCode",
    availability: "GBP",
    type: "categorical",
    default: "USD",
    explanation:
      '_online2PayCurrencyCode (default USD) allows the scientist to specify the ISO 4217 three-letter currency code of the currency of payment to the participant. For example "USD" for US Dollars, "EUR" for Euros, and "GBP" for British Pounds.\nhttps://en.wikipedia.org/wiki/ISO_4217\n\nA statement of payment to the participant appears below the consent form. The amount is _online2Pay plus the product of expected duration _online2Minutes / 60 and pay per hour _online2PayPerHour. That number is followed by _online2PayCurrencyCode as the unit of currency. For example "15.00 USD". Use _online2PayShow to control what\'s shown.\n\n_online2PayCurrencyCode currently accepts any of 44 currency codes. We could implement all the ISO 4217 three-letter codes if anyone needs them. Write to denis.pelli@nyu.edu, with subject EasyEyes.\n\n\nCurrency                 ISO 4217 Currency Code\nArgentine peso           ARS\nAustralian dollar        AUD\nBrazilian real           BRL\nBritish pound sterling   GBP\nCanadian dollar          CAD\nChilean peso             CLP\nChinese yuan (renminbi)  CNY\nColombian peso           COP\nEgyptian pound           EGP\nEuro                     EUR\nHong Kong dollar         HKD\nIcelandic króna          ISK\nIndian rupee             INR\nIndonesian rupiah        IDR\nIranian rial             IRR\nIraqi dinar              IQD\nIsraeli new shekel       ILS\nJapanese yen             JPY\nJordanian dinar          JOD\nKuwaiti dinar            KWD\nLebanese pound           LBP\nMalaysian ringgit        MYR\nMexican peso             MXN\nMoroccan dirham          MAD\nNew Taiwan dollar        TWD\nNew Zealand dollar       NZD\nNigerian naira           NGN\nPakistani rupee          PKR\nPeruvian sol             PEN\nPhilippine peso          PHP\nQatari riyal             QAR\nRussian ruble            RUB\nSaudi riyal              SAR\nSingapore dollar         SGD\nSouth African rand       ZAR\nSouth Korean won         KRW\nSwiss franc              CHF\nSyrian pound             SYP\nThai baht                THB\nTurkish lira             TRY\nUAE dirham               AED\nUS dollar                USD\nVietnamese dong          VND\n\nNOT YET IMPLEMENTED:  CHECK Prolific. Your Prolific account is set to use either USD or GBP. Prolific has no API to change currency, but, in a planned enhancement of _online2PayCurrencyCode, if \n_online1RecruitmentService === ”Prolific”\nthen EasyEyes will confirm that Prolific is using the currency declared by _online2PayCurrencyCode. Prolific allows your user account to be in USD or GBP, and you can (infrequently) change your Prolific account\'s currency by sending a written request to Prolific. Users of EasyEyes  residing in UK and will likely prefer to pay Prolific and participants in GBP. EasyEyes can\'t change Prolific\'s choice of currency, but EasyEyes will make sure that Prolific is using the currency assumed by your spreadsheet. If not, then EasyEyes will flag this as a fatal error at compile time. You can then fix _online2PayCurrencyCode in your study to match your Prolific account, and adjust _online2Pay or _online2PayPerHour to provide the desired compensation. ',
    example: "GBP",
    categories: [
      "AED",
      "ARS",
  ...
  _online2PayCurrencySymbol: {
    ...
    availability: "_online2PayCurrencySymbol",
    type: "text",
    default: "$",
    explanation:
      '_online2PayCurrencySymbol (default "$"). Currently not used. Ignored by Prolific, but may be usefull when recruiting directly. Allows the scientist to specify a symbol (any text string) for the currency of payment. This appears before the numerical amount to be paid, e.g. "$14.51". Examples: €, £, $, USD, US$. ',
  ...
  _online2PayPerHour: {
    ...
    default: "0",
    explanation:
      '⭑ _online2PayPerHour (default zero) specifies the hourly rate (a number) that determines (with _online2Minutes) the payment offered to each participant. [In Prolific, EasyEyes computes and fills in "How much do you want to pay them?"] The currency is specified by _online2PayCurrencyCode. If _online2Pay and _online2PayPerHour are both nonzero, then the participant is offered the sum of the two contributions. The pay is specified with two decimals (e.g. 11.01), rounding up to the next cent, so the hourly rate offered will never be less than specified by the study. Prolific lists the study titles and pay per hour for selection by prospective participants. Some participants mentioned selecting my study because it seemed interesting. Others said that in their rush to sign up for $15/hour studies, they often skip the description. \n\nA statement of payment to the participant appears below the consent form. The amount is _online2Pay plus the product of expected duration _online2Minutes / 60 and pay per hour _online2PayPerHour. That number is followed by _online2PayCurrencyCode as the unit of currency. For example "15.00 USD". Use _online2PayShow to control what\'s shown.\n',
    example: "15",
  },
  _online2PayShow: {
    name: "_online2PayShow",
    availability: "15",
    type: "categorical",
    default: "payAndTime",
    explanation:
      '_online2PayShow (default payAndTime) specifies what information is included in the EasyEyes statement, below the consent form, about how long the study is expected to take, and how much it pays. There are four cases:\nnone = suppress the statement.\npayAndTime = specify pay and expected time.\npay = specify only pay.\ntime = specify only expected time.\n\nA statement of payment to the participant appears below the consent form. The amount is _online2Pay plus the product of expected duration _online2Minutes / 60 and pay per hour _online2PayPerHour. That number is followed by _online2PayCurrencyCode as the unit of currency. For example "15.00 USD". Use _online2PayShow to control what\'s shown.',
    example: "15",
    categories: ["none", "pay", "time", "payAndTime"],
  },
  _participantIDGetBool: {
    ...
    default: "FALSE",
    explanation:
      "_participantIDGetBool (default FALSE). Multi-session studys require a way to link a participant's several sessions. When _participantIDGetBool is TRUE, we ask the participant to provide their EasyEyesID from a previous session. To facilitate this, EasyEyes checks for the most recent EasyEyesID cookie, and, if found, offers it to the participant for approval. The participant can approve it (if found), or select an EasyEyesID file from the computer's disk, or type in an EasyEyesID, or type in any ASCII alphanumeric string (also allowing underscore, dash, and period) without whitespace to use as their EasyEyesID. If EasyEyes cannot get an EasyEyesID, it exits the study. A participant who moves from one computer to another between sessions should take an EasyEyesID file with them, or write down the EasyEyesID. \nAlso see _participantIDPutBool below.",
    example: "TRUE",
  },
  ...
  _pavloviaNewExperimentBool: {
    ...
    default: "TRUE",
    explanation:
      "_pavloviaNewExperimentBool (default TRUE) can be set to FALSE to reuse the current Pavlovia repository. This is helpful when it's important to retain the same Pavlovia URL for your study, because another study links to it. It's also helpful for users without an institutional Pavlovia license, because assignment of credits in Pavlovia is specific to the repository, so it's more convenient to keep using the same repository.\n\nWithout an institutional license, Pavlovia requires assigning credit (money) to each study before it can run in RUNNING mode. (PILOTING mode is free, but only accessible manually within Pavlovia.) \n\nIf _pavloviaNewstudyBool=TRUE (the default), then, when EasyEyes compiles your study, EasyEyes appends the smallest possible integer (at least 1) to the spreadsheet filename (without extension) to create a unique (unused) study name. That keeps versions apart, and keeps the data from each version in its own repository. \n     Setting _pavloviaNewstudyBool=FALSE will reuse the old repo, instead of creating a new repo every time you compile. The downside is that if you collect data, edit the study, and collect more data, the data files will all be together in the same repo, distinguished only by date.\n     When _pavloviaNewstudyBool=FALSE, scientists without an institutional license only need to assign credit the first time they compile (when it's a new repo). Once it has credits, they can keep testing, through countless compiles, without visiting Pavlovia, until the study runs out of credits. \n     This flag doesn't affect PILOTING mode, which is always free and can only be used from within Pavlovia. \n     Also, any users concerned over the huge proliferation of repos might like to set _pavloviaNewstudyBool=FALSE to minimize the number of repos created by EasyEyes.\n\nSee _pavloviaPreferRunningModeBool for a more advice on working without an institutional Pavlovia site license.",
    example: "FALSE",
  },
  _pavloviaNewStudyBool: {
    name: "_pavloviaNewStudyBool",
    availability: "FALSE",
    type: "boolean",
    default: "TRUE",
    explanation:
      "_pavloviaNewStudyBool (default TRUE) can be set to FALSE to reuse the current Pavlovia repository. This is helpful when it's important to retain the same Pavlovia URL for your study, because another study links to it. It's also helpful for users without an institutional Pavlovia license, because assignment of credits in Pavlovia is specific to the repository, so it's more convenient to keep using the same repository.\n\nWithout an institutional license, Pavlovia requires assigning credit (money) to each study before it can run in RUNNING mode. (PILOTING mode is free, but only accessible manually within Pavlovia.) \n\nIf _pavloviaNewstudyBool=TRUE (the default), then, when EasyEyes compiles your study, EasyEyes appends the smallest possible integer (at least 1) to the spreadsheet filename (without extension) to create a unique (unused) study name. That keeps versions apart, and keeps the data from each version in its own repository. \n     Setting _pavloviaNewstudyBool=FALSE will reuse the old repo, instead of creating a new repo every time you compile. The downside is that if you collect data, edit the study, and collect more data, the data files will all be together in the same repo, distinguished only by date.\n     When _pavloviaNewstudyBool=FALSE, scientists without an institutional license only need to assign credit the first time they compile (when it's a new repo). Once it has credits, they can keep testing, through countless compiles, without visiting Pavlovia, until the study runs out of credits. \n     This flag doesn't affect PILOTING mode, which is always free and can only be used from within Pavlovia. \n     Also, any users concerned over the huge proliferation of repos might like to set _pavloviaNewstudyBool=FALSE to minimize the number of repos created by EasyEyes.\n\nSee _pavloviaPreferRunningModeBool for a more advice on working without an institutional Pavlovia site license.",
    example: "FALSE",
  },
  ...
  _phrasesColumnName: {
    ...
    default: "",
    explanation:
      '🕑 _phrasesColumnName (default empty) accepts a column name (content of cell in top row) in the _phrasesSpreadsheet. That column will be used in replacing each symbolic name with a phrase.\n\nThe compiler will throw an error if the _phrasesColumnName value does not appear in the first row of the _phrasesSpreadsheet.\n\nThe scientist uses this capability by typing a _phrasesSpreadsheet row name as the value of any parameter. The row name must begin with "!", and must appear in the first column of the _phrasesSpreadsheet.',
    example: "",
  },
  _phrasesSpreadsheet: {
    name: "_phrasesSpreadsheet",
    availability: "",
    type: "text",
    default: "",
    explanation:
      "🕑 _phrasesSpreadsheet (default empty) specifies the filename of a spreadsheet file, e.g. DenisPhrases.xlsx, that offers replacement of any number of symbolic names by phrases translated into an arbitrary set of languages. The compiler throws an error if the spreadsheet is not available. The first column is symbolic names. The other columns hold phrases, and each column has a unique column name in row 1. \nThe scientist can specify a symbolic name preceded by ~ as the value for any parameter in the EasyEyes study spreadsheet. The symbolic name must appear in the first column of the _phrasesSpreadsheet. The ~ and symbolic name will be replaced by a lookup in the scientist's _phrasesSpreadsheet, using the row whose first cell matches the symbolic name, and using the column whose name matches _phraseColumnName.\n\nThe phrases spreadsheet must support color (i.e. .XSLX is ok and .CSV is not). If a phrase's cell background in columns 3+ is white (#ffffff) then EasyEyes will replace it with a DeepL translation of the second-column cell in the same row. A cell with any other background is left unmodified.\n\nEXPORT TO EXAMINE THE PHRASES. The scientist submitted a phrases sheet to the EasyEyes compiler, which saves it as a resource in the scientist's Pavlovia account. To examine it, choose a study that uses that resource, and use the compiler's Export button. The export.zip includes all resources needed by the study, including the phrases spreadsheet.",
    example: "",
  },
  _prolific1ProjectID: {
  ...
  _prolific3AllowAfterHours: {
    ...
    default: "0",
    explanation:
      "_prolific3AllowAfterHours (default 0) requires that at least the specified (floating) number of hours pass since completion of the _prolific3AllowCompletedstudy before the participant’s ID is added to the allowList.",
    example: "",
  },
  _prolific3AllowCompletedExperiment: {
    ...
    default: "",
    explanation:
      "_prolific3AllowCompletedExperiment (default empty) specifies a comma-separated list of studys (typically just one) in your Pavlovia account. (The compiler will check the study names.) A minimum time _prolific3AllowAfterHours after a participant completes (or has completed) one or more of the named studys, EasyEyes will add their Prolific participant ID to the current study’s allowList. Adding continues until the new study completes. If _prolific3AllowCompletedstudy is not empty, then participants are recruited solely through the allowList. If _prolific3CustomAllowList is not empty, then it adds its IDs to the allowList.",
    example: "",
  },
  _prolific3AllowCompletedStudy: {
    name: "_prolific3AllowCompletedStudy",
    availability: "",
    type: "text",
    default: "",
    explanation:
      "_prolific3AllowCompletedStudy (default empty) specifies a comma-separated list of studys (typically just one) in your Pavlovia account. (The compiler will check the study names.) A minimum time _prolific3AllowAfterHours after a participant completes (or has completed) one or more of the named studys, EasyEyes will add their Prolific participant ID to the current study’s allowList. Adding continues until the new study completes. If _prolific3AllowCompletedstudy is not empty, then participants are recruited solely through the allowList. If _prolific3CustomAllowList is not empty, then it adds its IDs to the allowList.",
    example: "",
  },
  ...
  _prolific3CustomAllowList: {
    ...
    default: "",
    explanation:
      '_prolific3CustomAllowList [Prolific "Custom allowlist"] (no default) is a comma-separated list of Prolific participant IDs. ONLY these participants will be eligible for this study, unless _prolific3AllowCompletedstudy is not empty, in which case both contribute to the allowList of participants.',
    example: "",
  },
  ...
  _saveCursorPositionBool: {
    ...
    default: "FALSE",
    explanation:
      "_saveCursorPositionBool (default FALSE) records cursor and crosshair position at every display frame throughout the study. At the end of the study, EasyEyes saves a CSV file to the \"data\" folder in the study's Pavlovia repository. (Based on the similar, but now deprecated _trackGazeExternallyBool.)\nCURSOR CSV TABLE. Each row of the EasyEyes CSV “cursor” table records posix time (in secs, floating point), x,y position (px) of the: crosshair, cursor, and (if present) target. We also include viewing distance (cm), x,y of closest point (px) to observer's eyes, study name, Pavlovia session ID, block number, condition number, conditionName, and trial number.\nNOTE: To download a cursor file (_saveCursorPositionBool=TRUE), Pavlovia must use the CSV results format (_pavlovia_Database_ResultsFormatBool=FALSE, the default). Otherwise the cursor data file will not appear. At some point we'll enhance the compiler to raise an error when both are true.",
    example: "",
  },
  _saveEachBlockBool: {
  ...
  _screenColorSpace: {
    name: "_screenColorSpace",
    availability: "screenColorSpace",
    type: "categorical",
    default: "srgb",
    explanation:
      "🕑 _screenColorSpace (default srgb) selects the color space (srgb or display-p3) of the Canvas used by PIXIJS.",
    example: "screenColorSpace",
    categories: ["srgb", "display-p3"],
  },
  _screenDitherBool: {
    name: "_screenDitherBool",
    availability: "screenDitherBool (default FALSE).",
    type: "boolean",
    default: "FALSE",
    explanation: "🕑 _screenDitherBool (default FALSE)",
    example: "screenDitherBool (default FALSE).",
  },
  _screenFloat16Bool: {
    name: "_screenFloat16Bool",
    availability: "screenFloat16Bool (default FALSE)",
    type: "boolean",
    default: "FALSE",
    explanation: "🕑 _screenFloat16Bool (default FALSE)",
    example: "screenFloat16Bool (default FALSE)",
  },
  ...
  _showTitlePage: {
    name: "_showTitlePage",
    availability: "showTitleDescription",
    type: "categorical",
    default: "title",
    explanation:
  ...
  _timeoutSoundCalibrationSec: {
    ...
    default: "1.00E+06",
    explanation:
      "⭑ _timeoutSoundCalibrationSec (default 1e6) indicates how long to wait before timing out. We set it long to allow for slow internet connections. This is for development. Ultimately EasyEyes should always cope with slow internet connections, but this aids our search for a general solution.\nIMPORTANT: The 1000 Hz sound calibration fails with _timeoutSoundCalibrationSec=20, and works with _timeoutSoundCalibrationSec=1e6. studys that need sound calibration should set _timeoutSoundCalibrationSec=1e6 to be safe until a lower safe value is found. (I'd guess that 60 would be enough, depending on how long the 1000 Hz recordings are.)",
    example: "",
  },
  _trackGazeExternallyBool: {
    ...
    default: "FALSE",
    explanation:
      "When _trackGazeExternallyBool is TRUE (default is FALSE), then EasyEyes uses a RESTful node to turn on gaze tracking at onset of study and turn it off at end of study. And, at the end of the study, EasyEyes saves a CSV file to the Downloads folder. \nSTIMULUS CSV TABLE. Each row of the EasyEyes CSV “stimulus” table records posix time (in secs, floating point), x,y position (px) of the: crosshair, cursor, and (if present) target. We also include viewing distance (cm), x,y of closest point (px), study name, Pavlovia session ID, block number, condition number, conditionName, and trial number.\nGAZE CSV TABLE. We assume that the external gaze tracker creates another csv file. We have a MATLAB program for this. Each row of that “gaze” table records posix time (in secs, floating point) and x,y gaze position (px), roughly every 10 ms. \n\nEasyEyes and MATLAB drop their CSV tables into the Downloads folder. EasyEyes (“stimulus”) and MATLAB (“gaze”) each generate one file for the whole study.",
    example: "",
  },
  ...
  _workAroundMissingSpaceBarBool: {
    ...
    availability: "_acceptReturnAsSpaceBool",
    type: "boolean",
    default: "FALSE",
    explanation:
  ...
  block: {
    ...
    default: "",
    explanation:
      '⭑ The block number (no default) is required in every condition. The first condition (column C) must have block==1. After the first condition, each successive condition (column) rightward must have the same block number as the one preceding it, or increased by +1.\n\nBLOCK NUMBER IS CONSERVED. EasyEyes offers several ways to change the sequence of blocks, but any given condition is always shown with the block number assigned to it in the block row of the spreadsheet. Thus, when a block is suppressed by conditionEnabledBool=FALSE, the rest of the blocks are presented with their original numbers, leaving a gap. Similarly, when block order is changed by blockShuffleGroups, the blocks may not be in the original strictly-increasing sequence. In principle, the gap or non-monotic order could be noticed by participants, but none ever reported that to me. If the participant\'s awareness of modified block order is a concern, you can use showCounterBool=FALSE to hide the block number display. That minor concern is outweighed by the great convenience of having a reliable block number for bug reporting and data analysis.\n\nYour Excel spreadsheet can automatically compute the block number for each condition after the first. The first condition (in column C) is block 1. Assuming "block" is in cell A7, then set Excel cell C7 to 1. The next condition\'s block is in cell D7. If it\'s the same block, set it to "=C7". If it\'s a new block, set it to "=C7+1". Doing that for the block number in all your conditions will make it easier to edit your study.\n\nSHUFFLING. Shuffling preserves the total number of blocks and conditions. Despite shuffling by blockShuffleGroups1, blockShuffleGroups2, etc., each block retains its original block number in the CSV results file. Blocks are performed and reported in the shuffled column order, left to right, so in the CSV results, the block number sequence will be nonmonotonic and will vary across participants, but the block numbers will correspond between the study spreadsheet and results files.',
    example: "1",
  },
  blockShuffleGroups1: {
  ...
  calibrateFrameRateUnderStressBool: {
    ...
    default: "FALSE",
    explanation:
      "⚠️ WORKS BUT FAILS TO PREDICT TIMING PROBLEMS, SO NOT USEFUL. Set calibrateFrameRateUnderStressBool TRUE (default FALSE) to ask the Remote Calibrator (which runs at beginning of the study) to run a several-second-long test of graphics speed. The test is run if any condition requests it, and is only run once, regardless of the number of requests. This value is reported by the output parameter frameRateUnderStress in the CSV data file⚠️",
    example: "TRUE",
  },
  ...
  calibrateScreenSizeAllowedRatio: {
    ...
    availability: "calibrateTrackDistanceAllowedRatio",
    type: "numerical",
    default: "1.03",
    explanation:
  ...
  conditionEnabledBool: {
    ...
    default: "TRUE",
    explanation:
      "⭑ conditionEnabledBool (default TRUE) allows you to easily and reversibly omit individual conditions from your study  during development, without deleting columns or renumbering blocks. Except for block-number checking, EasyEyes ignores any condition (column C or greater in the study table) disabled by conditionEnabledBool===FALSE. \n\nThe compiler ignores conditionEnabledBool when it checks for consecutive block numbering. From left to right, the first condition column (C) must have block=1, and the block number of each further nonempty column to the right must be the same as or one more than the block number of the column to its left.\n\nconditionEnabledBool tells EasyEyes to ignore a column. To ignore a row, insert % as its first character in column A.\nEXAMPLE. As noted above, disabling a column, unlike deleting it, doesn't affect block numbering. If you have three blocks and disable block 2, you'll be left with blocks 1 and 3 active, and the compiler won't complain. If, instead, you deleted block 2 then you'd have to renumber block \"3\" to be \"2\", or get a compiler error about non-consecutive block numbering.\n\nNOTE. The compiler's enforcement of consecutive block numbering ignores conditionEnabledBool. Other than that, values in ignored columns (conditionEnabledBool==FALSE) should not affect the compiled program. If you find such an effect, please report it as a bug. Send a short study that exhibits the problem to denis.pelli@nyu.edu with subject \"EASYEYES BUG\".\n\nBLOCK NUMBER IS CONSERVED. EasyEyes offers several ways to change the sequence of blocks, but any given condition is always shown with the block number assigned to it in the block row of the spreadsheet. Thus, when a block is suppressed by conditionEnabledBool=FALSE, the rest of the blocks are presented with their original numbers, leaving a gap. Similarly, when block order is changed by blockShuffleGroups, the blocks may not be in the original strictly-increasing sequence. In principle, the gap or non-monotonic order could be noticed by participants, but none ever reported that to me. If the participant's awareness of modified block order is a concern, you can use showCounterBool=FALSE to hide the block number display. That minor concern is outweighed by the great convenience of having a reliable block number for bug reporting and data analysis that is consistent between your study spreadsheet, the showCounterBool display in lower right corner while running, and the results CSV spreadsheet.",
    example: "FALSE",
  },
  conditionGroup: {
    name: "conditionGroup",
  ...
  fontBoundingScalar: {
    ...
    default: "1",
    explanation:
      "⚠️ fontBoundingScalar (default 1.0) was a temporary workaround used to prevent letters from falling partly offscreen. It allows the scientist to scale up the font’s bounding box. We rewrote the code that lays out text for typographic crowding, so there should no longer be any need for this hask.",
    example: "",
  },
  fontCharacterSet: {
    name: "fontCharacterSet",
    availability: "DHKNORSVZ",
    type: "text",
    default: "abcdefghijklmnopqrstuvwxyz",
    explanation:
  ...
  fontDirection: {
    ...
    default: "LTR",
    explanation:
      'fontDirection (default "LTR") sets text direction of this condition\'s stimulus. It now supports left and right horizontal writing directions. In the future it will also support vertical writing directions.\nThe values of fontDirection are:\n"ltr" or "LTR";  Horizontal, left to right. \n"rtl" or "RTL";  Horizontal, right to left.\n"vertical-rl";   Vertical, top to bottom, columns right to left.\n"vertical-lr";   Vertical, top to bottom, columns left to right.\nThe vertical options, not yet implemented, will enhance support for Japanese, which can be written either ltr or vertical-rl.\n\nUse LTR (or the equivalent ltr) for languages, like English, that are written from left to right, and RTL (or rtl) for right-to-left languages, like Arabic, Hebrew, and Persian.  Throughout EasyEyes, left-to-right text is left-aligned, and right-to-left text is right aligned. If fontDirection is set incorrectly, text may fall off the screen.\n\nNOTE. fontDirection controls only the current condition\'s stimulus. The direction of instructional messages to the participant, for the whole study, is set by EE_languageDirection in the international phrases, which is selected by _language. The scientist sets _language in the study spreadsheet. It normally has only one value for the whole study. \n\nLIMITED SUPPORT. _languageSelectionByParticipantBool allows runtime selection of language, overriding _language, and appropriately updating EE_languageDirection. However, some of the EasyEyes language support is implemented at compile-time, not run-time, so be aware that _languageSelectionByParticipantBool is only partially supported and is intended for demos, not serious data collection.\n\nfontDirection affects several aspects of layout. EasyEyes left-aligns LTR text and right-aligns RTL text. It also arranges controls, such as buttons, with a left-to-right emphasis on LTR pages and a right-to-left emphasis on RTL pages.\n\nThe direction of strongly directional text (such as words written in Arabic or English) is determined by the characters themselves. However, the placement of words and weakly directional characters (such as punctuation) is determined by the Unicode Bidirectional (bidi) algorithm, which considers both the directionality of individual characters and the base direction of the surrounding text block. fontDirection sets that base direction for every block of text.\n\nAlso see fontPunctuationRTL, a brute force technique that tells the bidi algorithm to treat some punctuation as RTL.\n\nAlso see readingCorpusCleanupPunctuation to fix loose punctuation that may confusingly appear at the beginning of a line. That problem is a bad corpus, but might be misdiagnosed as a fontDirection problem. readingCorpusCleanupPunctuation might fix it for you.\n\nMETHOD\n(Nati Tsegaye & Augustin Burchell, July, 2026)\n\nRendering right-to-left text. Accurate measurement of reading speed in Arabic, Persian, Urdu, and other right-to-left scripts requires that text be rendered with the correct paragraph base direction. We implemented this in EasyEyes through the `fontDirection` parameter, which specifies whether text should be rendered left-to-right (LTR) or right-to-left (RTL). This direction is not merely an alignment preference: it is an input to the Unicode bidirectional algorithm, which determines the visual order of characters in mixed-direction text [1].\n\nSome punctuation has weak directionality. The issue is especially important for punctuation. Arabic-script letters have the Unicode bidirectional class AL (“Right-to-Left Arabic”), which is a strong directional type. By contrast, several common punctuation marks are not strongly directional: the ASCII comma "," and full stop ".", and the Arabic comma "،" [U+060C] have bidirectional class CS (“Common Separator”), a weak type, and the ASCII horizontal ellipsis "…" has bidirectional class ON (“Other Neutral”), a neutral type [1]. When such punctuation occurs at the end of a line, it may have a strong right-to-left character on only one side. In that case, its placement depends on the paragraph base direction. If Arabic text is rendered with an unintended left-to-right base direction, a sentence-final period or comma may be (wrongly) displayed at the right edge of the line, which is visually the beginning of an RTL line, rather than (correctly) at the left edge, which is the end of the line. This known issue is avoided by correctly setting the base direction of the paragraph (in this case to RTL).\n\nReapply direction after each canvas resize. A further implementation detail was critical. The (Javascript) Canvas drawing context state is reset whenever the Canvas width or height is assigned. The text renderer resizes its internal Canvas as part of the text drawing process, which silently resets drawing-state properties, including `direction`. Therefore, setting the canvas direction only once is insufficient. EasyEyes re-applies the requested direction after each canvas resize, immediately before the text is drawn.\n\n[1]. Unicode Consortium. Unicode Standard Annex #9: Unicode Bidirectional Algorithm. Unicode 17.0.0, Revision 51, 13 Aug. 2025. Unicode Consortium. https://unicode.org/reports/tr9/',
    example: "",
    categories: ["LTR", "RTL", "ltr", "rtl", "vertical-rl", "vertical-lr", ""],
  },
  fontFeatureSettings: {
    ...
    default: "",
    explanation:
      'fontFeatureSettings (no default) allows the scientist to specify how the font should use its glyphs to render a script or language. fontFeatureSettings receives a string. The default is the empty string. A typical value is\n"calt" 1\nor\n"calt" 1, "smcp", "zero"\nEach line above is a string that is passed to the CSS function "font-variation-settings". The (single or double) quote marks are required. Each four letter code is taken from a long list of possible font features. "calt" enables the font’s "contextual alternates", especially connections between adjacent letters in a script font. "smcp" enables small caps. "zero" requests a slash through the zero character to distinguish it from capital O. Most font features are Boolean and accept an argument of 0 for off and 1 for on. Some accept an integer with a wider range. Supported by all modern browsers, and even Internet Explorer.\nhttps://developer.mozilla.org/en-US/docs/Web/CSS/font-feature-settings\nhttps://docs.microsoft.com/en-us/typography/opentype/spec/features_ae#tag-calt\nhttps://helpx.adobe.com/in/fonts/using/open-type-syntax.html\nhttps://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-ligatures\nhttps://en.wikipedia.org/wiki/Ligature_(writing)\nhttps://stackoverflow.com/questions/7069247/inserting-html-tag-in-the-middle-of-arabic-word-breaks-word-connection-cursive/55218489#55218489\n\nFor best rendering of the Noto Nastaliq Urdu font, ChatGPT\'s recommendations are equivalent to:\nfont = "Noto Nastaliq Urdu"\nfontDirection = rtl;\nfontFeatureSettings = "init" on, "medi" on, "fina" on, "isol" on, "rlig" on, "calt" on, "curs" on, "kern" on    // For older browsers.\nfontSource = google\nfontTextRendering = optimizeLegibility\nfontVariantLigatures = common-ligatures, contextual    // Enable all necessary OpenType ligatures.\nreadingLineSpacingMultipleOfSingle = 2.5  // Nastaliq is tall.\n\nBased on limited research, the codes mentioned above in ChatGPT\'s suggested font-features-settings are already applied by default by the HarfBuzz font engine (used by Chrome, Chromium, and Firefox).\n\nHow fontFeatureSettings keywords help render Nastiliq\nThe string of four-letter codes provided to fontFeatureSettings acts as a direct instruction manual for the browser. Here is why they are vital for Nastaliq:\n• init, medi, fina, isol: These handle the four cursive forms of Arabic/Urdu/Persian letters (Initial, Medial, Final, and Isolated). Without these, letters won\'t connect at all.\n• rlig (Required Ligatures): Essential for fundamental character combinations (like Lam-Alef).\n• calt (Contextual Alternates): This is the secret sauce for Nastaliq. It shifts the shape and vertical position of a letter based on the letters that come before and after it, allowing the text to "cascade" downward.\n• curs (Cursive Positioning): Ensures that the exit point of one letter precisely matches the entry point of the next.\n• kern (Kerning): Prevents the dots (nuqtas) of one word from crashing into the body of another word.\n\nWHICH FONT ENGINE. Chrome, Chromium, and Firefox use the HarfBuzz font engine. HarfBuzz docs say that it activates by default: abvm, blwm, ccmp, locl, mark, mkmk, rlig always, and for horizontal text (incl. Arabic) additionally calt, clig, curs, dist, kern, liga, rclt. So rlig/curs/calt/kern are all on by default. (init/medi/fina/isol are Arabic-shaper-required, applied unconditionally.)\n\nIMPLEMENTATION. fontFeatureSettings and fontVariantLigatures capabilties do not exist in the Canvas 2D api. Gemini/ChatGPT provide CSS examples which are not compatible/relevant here, in the Canvas API context  – this is the same reason we have to “bake in” our variable font settings and stylistic sets with compile time font processing. So we implement fontFeatureSettings in our compile-time font-baking way (ie making a font instance where the desired option is made the only option). \n\nFROM GUS. I’d recommend testing the Nastaliq font examples now, and seeing if they look right already. In my testing, the word cascading appears to be working correctly (naive observer though, obviously). Assuming it’s the within-word cascade we’re interested in; it looks like neither HTML nor Canvas support an across-words (within-line?) cascade. (Again, naive observer/non-speaker, so I don’t know that expected/usual use case is.)',
    example: "",
  },
  fontKerning: {
    name: "fontKerning",
  ...
  fontLanguage: {
    ...
    default: "",
    explanation:
      'fontLanguage (default empty) allows specification of the language being typeset. The BCP 47 standard specifies a two-or-three-letter code for each language, e.g. en for English, ar for Arabic, and fa for Farsi/Persian. That can be extended by hyphenated suffixs to be more specific, e.g. en-US and en-GB. fontLanguage currently allows about one hundred languages. We\'ll add new languages, as needed.\n\nTo allow use of special symbol fonts, e.g. for acuity testing, you can specify fontLanguage=none to disable language checking.\n\nThis is considered redundant when the language is English, but is supposed to improve rendering of some details of middle eastern languages. The BCP 47 web site says, "Note: If the language is written in a highly typical way, like English in the Latin alphabet, there is no need to use this subtag."\n\nBy default, the EasyEyes compiler checks font compatibility with the language specified by fontLanguage.\n\nSetting either\nfontLanguage = none\nor\nfontTolerateFaults = wrongLanguage\ndisables language checking of the font. Iconic fonts meant for vision testing (e.g. Sloan.otf or Steve Dakin\'s Auckland Optotypes) typically have too few glyphs to fully support any language. When you use such fonts, we suggest setting fontLanguage = none  to tell the compiler not to check for language support.\n\nBROWSER COMPATIBILITY: fontLanguage is implemented by using the HTML "lang" feature. As of April 2026, use of the HTML "lang"  feature in the Javascript Canvas is supported by Chrome, Edge, and Opera browsers, and NOT SUPPORTED by Safari and Firefox. So, to reliably benefit from fontLanguage, you must use _needBrowser to require compatible browsers.\nhttps://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lang\n\nERROR MESSAGE: The compiler error for this parameter says:\n"Sorry, the language code "xx" is not yet supported by the fontLanguage parameter. Write to denis.pelli@nyu.edu to ask that it be added."\n\nAlso see fontTolerateFaults.\n\n42 LANGUAGES\n42 languages (below) are currently accepted. They include the main european languages and every language with at least 100 million speakers worldwide, based on Ethnologue’s estimates of total first- and second-language speakers. We\'ll add more as needed. Write to denis.pelli@nyu.edu with SUBJECT: EasyEyes.\nhttps://developer.mozilla.org/en-US/docs/Glossary/BCP_47_language_tag\nArabic:                ar\nBengali:               bn\nChinese (Simplified):  zh-Hans\nChinese (Traditional): zh-Hant\nCzech:                 cs\nDanish:                da\nDutch:                 nl\nEnglish:               en\nFilipino:              fil\nFinnish:               fi\nFrench:                fr\nGerman:                de\nGreek:                 el\nHausa (Latin):         ha-Latn               \nHebrew:                he\nHindi:                 hi\nHungarian:             hu\nIndonesian:            id\nItalian:               it\nJapanese:              ja\nJavanese:              jv\nKorean:                ko\nMalay:                 ms\nMarathi:               mr\nNigerian Pidgin:       pcm\nNorwegian:             no\nPersian:               fa\nPolish:                pl\nPortuguese:            pt\nPunjabi:               pa\nRomanian:              ro\nRussian:               ru\nSpanish:               es\nSwahili:               sw\nSwedish:               sv\nTamil:                 ta\nTelugu:                te\nThai:                  th\nTurkish:               tr\nUkrainian:             uk\nUrdu:                  ur\nVietnamese:            vi',
    example: "",
    categories: [
      "none",
      "en",
  ...
  fontLeftToRightBool: {
    ...
    type: "obsolete",
    default: "",
    explanation: "❌ Use fontDirection instead.",
    example: "FALSE",
  },
  fontLimitTripletExtentBool: {
    name: "fontLimitTripletExtentBool",
    availability: "",
    type: "boolean",
    default: "TRUE",
    explanation:
      "fontLimitTripletExtentBool (default TRUE) when TRUE tells EasyEyes, in the crowding task, to directly limit triplet size to stay on screen. When FALSE, EasyEyes is indirect. It uses another string, possibly the alphabet, to compute a maximum font size. This indirect scheme risks that a particularly long triplet will extend off screen, but has the virtue that font size per se offers the participant no clue to the target identify. We recommend \nfontLimitTripletExtentBool = FALSE for Roman fonts, and \nfontLimitTripletExtentBool = TRUE for Arabic-like fonts. \n\nIn years of testing Roman fonts we never saw a problem with fontLimitTripletExtentBool = FALSE. However, in limited testing of IranNastaliq, a Persian font, with fontLimitTripletExtentBool = FALSE, Sajjad Mazaheri discovered triplets extending off screen. We anticipate that setting fontLimitTripletExtentBool = TRUE will eliminate this problem. We have not assessed whether font size now helps the participate identify the target, but we suppose that the help is negligibly small.",
    example: "",
  },
  fontMaxPhysicalPx: {
  ...
  fontPixiMetricsString: {
    ...
    default: "",
    explanation:
      "fontPixiMetricsString (default: determined by fontLanguage) specifies the text sample used to measure the vertical extent of the condition's font. EasyEyes renders text through PsychoJS and PIXI.js, which uses the text sample in PIXI.TextMetrics.METRICS_STRING to measure the font's vertical extent. fontPixiMetricsString tells EasyEyes what text to push into PIXI.TextMetrics.METRICS_STRING. Before drawing text, PIXI allocates an area with a vertical extent based on the largest ascender and descender found in that text sample, plus fontPadding. Pixels beyond that area are clipped. PIXI’s standard metrics string, |Éq, works well for Roman alphabets, thought not all fonts, and is unsuitable for non-Roman text. You may specify a different fontPixiMetricsString for each condition. If the value is empty or unspecified, EasyEyes selects a default based on fontLanguage. Current language-specific defaults include:\nArabic (ar): أج بي\nPersian (fa): گجل ایچ\nUrdu (ur): گھج بپج\nSimplified Chinese (zh-Hans): 高黑\nTraditional Chinese (zh-Hant): 高黑\nJapanese (ja): 高黒\nYou can see the current defaults in the Default field of the Glossary entry for fontPixiMetricsString. For Roman-alphabet languages such as English, Italian, and German, the default is |Éq. Suggestions for additional language-specific defaults are welcome.\n\nThe default string is a comma-separated list. For each language there are two strings separated by a comma, first the language code, then the text sample. Like this:\nar, كجل بجد, fa, گجل ایچ, ja, 高黒, ur, گھج بپج, zh-Hans, 高黑, zh-Hant, 高黑\nWhen the compiler reads the default string, it check that the odd-numbered strings (ar, fa, ja,…) are valid languages, and throws a fatal error if they aren't. \n\nSee also fontPadding and the PIXI.TextMetrics documentation:\nhttps://pixijs.download/v4.8.9/docs/PIXI.TextMetrics.html#.METRICS_STRING",
    example: "",
  },
  fontPositionalShapeResponse: {
    ...
    default: "normal",
    explanation:
      'fontPositionalShapeResponse (default normal) is for Arabic, Persian, Urdu, Pashto, etc. Does nothing when "normal". When it\'s "target", it imposes the target letter\'s positional form on every response alternative. Having the target letter change shape between stimulus and response screens might make it harder to identify, especially by less fluent readers. To make the target form consistent between stimulus and response screens, when fontPositionalShapeResponse === target, we check the triplet containing the target and impose the target\'s positional form on the single response characters. We induce a prefix connection using the tatweel joiner character (U+0640). We induce a suffix connectio using the zero-width joiner (ZWJ) character (U+200D). For more on these characters in Arabic typesetting see https://www.w3.org/TR/alreq/#h_joining_enforcement\nALSO SEE: fontMedialShapeTargetBool',
    example: "",
  ...
  fontPunctuationRTL: {
    name: "fontPunctuationRTL",
    availability: "",
    type: "categorical",
    default: "none",
    explanation:
      'fontPunctuationRTL (default none) applies a brute-force fix for misplaced ASCII punctuation in the display of RTL text. It modifies punctuation to help the Unicode bidirectional (“bidi”) algorithm assign the correct direction to punctuation characters that can appear in both LTR and RTL texts.\n\nNO LONGER NEEDED: Since Spring 2026, EasyEyes correctly sets the base direction of text, eliminating the need for this brute force fix.\n\nWithout this processing, the bidi algorithm may incorrectly assign the wrong text direction to the punctuation. The typical symptom is that a period, comma, semicolon, or ellipsis that belongs at the left edge (the end) of an RTL line instead appears at the right edge (the beginning).\n\nNormally, setting fontDirection to rtl should be enough. Use fontPunctuationRTL only if punctuation is still misplaced.\n\nWhen fontPunctuationRTL is set to RLM or ALM, it makes the following changes:\n\n1. After each final ASCII period "." and ellipsis "…", append the selected invisible Unicode direction mark, either RLM (U+200F) or ALM (U+061C).\n2. Replace each final ASCII comma "," and semicolon ";" with the correponding Arabic comma "،" (U+060C) or semicolon "؛" (U+061B).\n\n"final": A punctuation mark is considered "final" if it is followed by a space or is the last character in the string. This avoids changing punctuation embedded within text or numbers, such as a,b,c, 3.14, or 3,14 (or their RTL equivalents).\n\nThe fontPunctuationRTL value can be:\n\n• none — Do not modify punctuation.\n• ALM — Insert the Arabic Letter Mark (U+061C) after each final period and ellipsis. ALM was designed for Arabic-script text and is recommended for Arabic, Persian, and Urdu.\n• RLM — Insert the Right-to-Left Mark (U+200F) after each final period and ellipsis. Use this for other RTL scripts, such as Hebrew.\n\nThe only difference between ALM and RLM is the invisible mark appended after each final period and ellipsis. Commas and semicolons are handled identically in both modes.',
    example: "",
    categories: ["none", "RLM", "ALM"],
  },
  fontRenderMaxPx: {
  ...
  fontSource: {
    ...
    default: "",
    explanation:
      '⭑ fontSource (empty by default). If specified, it must be file, google, adobe, morisawa, or browser.\nBrowsers silently substitute a fallback font when a requested font is unavailable or loads too slowly. This behavior helps keep the web usable, but it is undesirable in perception studys that require a particular font. We therefore recommend explicitly providing access to each required font—either as a font file or by asking EasyEyes to retrieve it at runtime from a font server.\nSupported font formats are TrueType (.ttf), OpenType (.otf), and Web Open Font Format (.woff and .woff2). We recommend .woff2 whenever available: it is the most compressed format, minimizing study-download time and browser memory use on the participant’s computer.\n\nNo matter what the fontSource is, participants do not need any accounts or passwords. Their browsers load the font through the project’s CSS embed code: fontSourceCSSEmbed.\n\nYou can set fontSource to:\n\nfile: Set font to the filename, including extension, of a font file in the Fonts folder of the EasyEyesResources repository in your Pavlovia account. The EasyEyes compiler verifies that the file is present before the study runs, avoiding runtime surprises. The folder is persistent and can be updated at any time through the EasyEyes app.  LIMITATION: The font filename must not contain spaces.\n\ngoogle: Set font to the font name recognized by the Google Fonts server. This name often includes spaces. Google fonts are free, so you don\'t need an account. https://fonts.google.com/\n\nadobe: Set font to the CSS font-family name shown in Adobe Fonts for the selected family and style. \nTo use an Adobe web font:\n1. Sign in to, or create an account at, https://fonts.adobe.com/.\n2. Select the desired font family and choose Add to Web Project. Create a new Web Project or select an existing one, then select the required styles and weights.\n3. Assign the Web Project (kit) ID to fontSourceProject. \n4. Copy the Web Project’s generated embed code exactly as provided and paste it as the value of fontSourceCSSEmbed.\n• An Adobe account is required to create and manage an Adobe Fonts Web Project. Adobe’s free access level includes a basic library (currently about 5,500 fonts); paid Creative Cloud plans provide access to the full library. Both free and paid fonts must be added to a Web Project before EasyEyes can display them. \n\nmorisawa: Set font to the CSS font-family name shown in Morisawa Fonts for the selected typeface and style. Morisawa Fonts primarily offers Japanese fonts, plus some Latin and multilingual families.\nTo use a Morisawa web font:\n1. Sign in to, or create an account at, https://morisawafonts.com/.\n2. In Web Project Settings, create a Web Font Project and add the desired licensed typefaces and styles.\n3. Add `run.pavlovia.org` as a permitted domain. \n4. Assign the Morisawa project ID to fontSourceProject.\n5. Copy the project’s generated CSS embed code exactly as provided and paste it as the value of fontSourceCSSEmbed.\n• A Morisawa account and an eligible Web Font plan are required to create and manage the project. Free or trial availability varies by plan and market; do not assume that a typeface can be used without an account or project. \n\nbrowser (NOT RECOMMENDED): Set the font parameter to a CSS font-family list (e.g. "Helvetica, Arial, sans-serif"). The browser will choose the first available font from the list. This is the standard way that web browsers select fonts. Browsers dot not report an error if the requested fonts are unavailable.\n\n\nSPECIFIC FONT. When fontSource is anything but "browser", EasyEyes does one of two things:\n1. displays your stimuli with the requested font to every participant, or\n2. throws a compile-time error reporting unavailability of the font.\n\nUNCERTAIN FONT. With fontSource="browser", no check is made, and each participant\'s browser may substitute a different font. Your text will be rendered, but you won\'t know in which font. On each participant\'s computer, if the requested font is unavailable, or takes too long to download, the browser silently substitutes another font. Your EasyEyes study cannot determine which font each participant\'s browser is using, so your study may run with a different font (differing across participants) than you intended, without your knowledge. This behavior is standard policy of web browsers. Web browsers are intended to keep pages working even when requested fonts are unavailable, so they automatically substitute an available font instead of reporting an error. It is possible, using specialized techniques, to discover whether substitution has occurred, and even to identify the font being used, by comparing rendered text with known reference fonts. However, EasyEyes does not perform these checks. For most scientific studies, we recommend avoiding fontSource="browser". Use it only if you want each participant to use whichever font is available on their device.\n\nAlso see fontSourceCSSEmbed and fontSourceProject.',
    example: "file",
    categories: ["file", "google", "adobe", "morisawa", "browser"],
  },
  fontSourceCSSEmbed: {
    name: "fontSourceCSSEmbed",
    availability: "",
    type: "text",
    default: "",
    explanation:
      '🕑 fontSourceCSSEmbed (empty by default). Some web-font servers (Adobe Fonts and Morisawa Fonts) require that the scientist create a collection of fonts, which they call a web-font "project". The scientist gives EasyEyes access to these fonts by assigning the project id to fontSourceProject, and the CSS embed code to fontSourceCSSEmbed. \nAlso see fontSource and fontSourceProject.',
    example: "",
  },
  fontSourceProject: {
    name: "fontSourceProject",
    availability: "",
    type: "text",
    default: "",
    explanation:
      '🕑 fontSourceProject (empty by default). Some web-font servers (Adobe Fonts and Morisawa Fonts) require that the scientist create a collection of fonts, which they call a web-font "project". The scientist gives EasyEyes access to these fonts by assigning the project id to fontSourceProject, and the CSS embed code to fontSourceCSSEmbed. \nAlso see fontSource and fontSourceCSSEmbed.',
    example: "",
  },
  fontStyle: {
    name: "fontStyle",
  ...
  fontTextRendering: {
    name: "fontTextRendering",
    availability: "",
    type: "categorical",
    default: "",
    explanation:
      'fontTextRendering (default auto) This is an SVG property that browsers also honor for HTML text (mainly Firefox and Safari; Chrome largely ignores it). For HTML, optimizeLegibility is generally the only non-default value worth considering.\nPossible values:\n• auto: Browser chooses the rendering strategy (default).\n• optimizeLegibility: Favor high-quality typography. Enables kerning, ligatures, and other advanced typography when available. Historically affected ligatures in some browsers.\n• geometricPrecision: Prioritize geometric accuracy over speed. Mostly intended for SVG. Little effect on normal HTML text.\n\nFor best rendering of the Noto Nastaliq Urdu font, ChatGPT\'s recommendations are equivalent to:\nfont = "Noto Nastaliq Urdu"\nfontDirection = rtl;\nfontFeatureSettings = "init" on, "medi" on, "fina" on, "isol" on, "rlig" on, "calt" on, "curs" on, "kern" on    // For older browsers.\nfontSource = google\nfontTextRendering = optimizeLegibility\nfontVariantLigatures = common-ligatures, contextual    // Enable all necessary OpenType ligatures.\nreadingLineSpacingMultipleOfSingle = 2.5  // Nastaliq is tall.\n',
    example: "",
    categories: ["auto", "optimizeLegibility", "geometricPrecision"],
  },
  fontTolerateFaults: {
    name: "fontTolerateFaults",
    availability: "",
    type: "multicategorical",
    default: "",
    explanation:
      "fontTolerateFaults (default empty) requests tolerance of specific font faults. By default, EasyEyes rejects any font (in any column) that has a defect likely to affect rendering of readingCorpus text, or any text in the condition's specified language (fontLanguage) in any of the study’s allowed browsers (_needBrowser). If you deliberately want to use a buggy font, you can explicitly allow one or more known faults.\n\nSpecify a comma-separated list containing any combination of:\n\n• wrongLanguage ignores readingCorpus, and asks whether the font generally supports fontLanguage, using ShaperGlot's language character sets and shaping tests. Tolerating this fault will result in systematic errors in the shapes of text strings rendered at runtime. \n\n• missingCharacters ignores fontLanguage, and asks whether the font can render every character in readingCorpus. Only the readingCorpus file is checked, so instructions and other text stimuli are not checked. Tolerating this fault will result in runtime rendering of each missing character as a .notdef glyph □. \n\n• badGSUB (bad glyph substitution table): The font’s OpenType GSUB (glyph substitution) table is malformed. See details below.\n\n• badGPOS (bad glyph positioning table). By default EasyEyes checks and throws a fatal error if the glyph positioning table is bad.\n\n• all: Accept all faults, disabling all font-fault checks. EasyEyes still verifies that the requested font is available.\n\nSetting either\nfontLanguage = none\nor\nfontTolerateFaults = wrongLanguage\ndisables language checking of the font. Iconic fonts meant for vision testing (e.g. Sloan.otf or Steve Dakin's Auckland Optotypes) typically have too few glyphs to fully support any language. When you use such fonts, we suggest setting fontLanguage = none to tell the compiler not to check for language support.\n\nShaperGlot. wrongLanguage uses Google's ShaperGlot to evaluate your font's support of fontLanguage. It accepts all four font formats: .TTF, .OTF, .WOFF, .WOFF2. To read about ShaperGlot, see the readme here:\nhttps://github.com/googlefonts/shaperglot\nWe recommend feeding your font directly to ShaperGlot to get a full report of your font's language support. Just drop your font onto SuperGlot's home page:\nhttps://googlefonts.github.io/shaperglot/\nThe online ShaperGlot only accepts desktop fonts (.TTF or .OTF). If your font license allows it, you can use any of several free online services  (Convertio, CloudConvert, or FreeConvert) to convert your web-format font (.WOFF or WOFF2) to a desktop format (.TTF or .OTF) that ShaperGlot will accept.\n\nbadGSUB (bad glyph substitution table): The font’s OpenType GSUB (glyph substitution) table is malformed. The HarfBuzz shaping engine (used by Chrome and other Chromium- and Firefox-based browsers) rejects the entire GSUB table, which may cause incorrect rendering of complex scripts such as Arabic, Urdu, and Persian. Apple’s CoreText engine (used by Safari and many macOS applications) ignores this defect, so it is unaffected.\n     EasyEyes checks for this fault only when one or more of the browsers listed in _needBrowser use the HarfBuzz shaping engine.\n     The fault was first observed in the Arabic font \"Al Thuluth\" (version 1.00, FontCreator 11.5, June 26, 2018), purchased from MyFonts in June 2026. Because HarfBuzz rejected the malformed GSUB table, shaping fell back to the font’s legacy Arabic Presentation Forms, producing errors including:\n1. Arabic: words ending in ـير (e.g. كبير, كثير, تأثير, مصير) were rendered with ـيز because the glyph mapped to Unicode U+FC91 (yeh+reh final ligature) was incorrectly drawn as yeh+zain.\n2. Urdu and Persian: medial and initial Farsi yeh (U+06CC) failed to connect because those presentation forms were missing from the font’s character map. Arabic yeh (U+064A) was unaffected because its presentation forms were present.\n     EasyEyes detects this fault by:\n1. Parsing the raw font file to determine whether it contains a GSUB table.\n2. Loading the font into HarfBuzz.\n3. Comparing the two results:\n    * if the font contains no GSUB table, the font passes (many simple fonts, such as Sloan, do not require GSUB);\n    * if the font contains a GSUB table but HarfBuzz reports that it exposes zero scripts, HarfBuzz has rejected the table, and EasyEyes reports a fatal badGSUB error.\n\nSee also: font, fontLanguage, _needBrowser.",
    example: "",
    categories: [
      "wrongLanguage",
      "missingCharacters",
  ...
  fontVariantLigatures: {
    ...
    default: "normal",
    explanation:
      'fontVariantLigatures (default "normal") controls ligatures. You can include several keywords.\nAllowed keywords:\n• normal: Use the browser/font defaults.\n• none: Disable all ligatures.\n• common-ligatures: Enable standard ligatures like fi, fl, ff.\n• no-common-ligatures: Disable standard ligatures.\n• discretionary-ligatures: Enable decorative ligatures if the font provides them.\n• no-discretionary-ligatures: Disable decorative ligatures.\n• historical-ligatures: Enable historical forms (rare).\n• no-historical-ligatures: Disable historical forms.\n• contextual: Enable contextual substitutions that depend on neighboring letters. Very important for many scripts.\n• no-contextual: Disable contextual substitutions.\n\nFor best rendering of the Noto Nastaliq Urdu font, ChatGPT\'s recommendations are equivalent to:\nfont = "Noto Nastaliq Urdu"\nfontDirection = rtl;\nfontFeatureSettings = "init" on, "medi" on, "fina" on, "isol" on, "rlig" on, "calt" on, "curs" on, "kern" on    // For older browsers.\nfontSource = google\nfontTextRendering = optimizeLegibility\nfontVariantLigatures = common-ligatures, contextual    // Enable all necessary OpenType ligatures.\nreadingLineSpacingMultipleOfSingle = 2.5  // Nastaliq is tall.\n',
    example: "",
    categories: [
      "normal",
      "none",
  ...
  instructionForStudy: {
    name: "instructionForStudy",
    availability: "",
    type: "text",
    default: "",
    explanation:
      "🕑 instructionForStudy (empty default, which has no effect) is instructional text to be presented once at the beginning of the whole study, before beginning the first block. It can appear in any condition, e.g. in the last condition of the last block, but is presented first, before the first first block. If instructionForstudy is defined in more than one condition in the study, then the several instances are concatenated, in their order of appearance in the study spreadsheet after shuffling. ",
    example: "",
  },
  instructionLanguage: {
  ...
  measureLuminance: {
    ...
    default: "off",
    explanation:
      "measureLuminance (default off) turns on sampling by the photometer during stimulus presentation. Set it to one of the following:\n• off: Does nothing.\n• measure: Take repeated photometer readings, as specified by measureLuminanceDelaySec and measureLuminanceHz.\n• pretend: for debugging without a photometer, simulate measurement (every reading is -1) to test timing. \n\nmeasureLuminance is currently implemented solely for targetKind='movie'.\nThe \"measure\" setting uses the Cambridge Research Systems Colorimeter, which must be plugged into a USB port of the computer and pointed at whatever you want to measure. \n\nTIP: An easy way to stably measure from a laptop screen is to lay the screen on its back (with keyboard sticking up in the air) and gently rest the photocell directly on the screen.\n\nUse measureLuminanceDelaySec and measureLuminanceHz to set the start time from movie onset and sampling rate. After sampling the stimulus, EasyEyes saves a data file called luminance-study-BLOCK-CONDITIONNAME-TRIAL.csv into the Downloads folder, where:\nstudy is the study name, \nBLOCK is the block number, \nCONDITIONNAME is the conditionName, and \nTRIAL is the trial number in the block. \n\nThe luminance*.csv file has four columns: \nframeTimeSec, movieValue, luminanceTimeSec, luminanceNits\n• frameTimeSec is when  (in fractional seconds) the frame is presented, relative to beginning of movie. The first value is zero, and it increments by 1/movieHz. There is one frame (and frameTimeSec value) for each value of movieValues.\n• movieValues is copied from the input parameter array movieValues. \n• luminanceTimeSec is time of measurement relative to the beginning of movie. Its first value is measureLuminanceDelaySec and each subsequent value increases by 1/measureLuminanceHz.\n• luminanceNits is measured luminance in nits. (A nit is also called cd/m^2, candelas per meter squared.) \n\nNOTES: measureLuminanceDelaySec and thus luminanceTimeSec can be negative. The frameTimeSec and luminanceTimeSec columns will be aligned only when measureLuminanceHz === movieHz.",
    example: "",
    categories: ["off", "measure", "pretend"],
  },
  ...
  notes: {
    ...
    default: "",
    explanation:
      "notes provides a place in the study spreadsheet to add comments about the condition that you want preserved in the data file. Ignored by EasyEyes, and saved with results.",
    example: "",
  },
  ...
  "questionAnswer@@": {
    ...
    default: "",
    explanation:
      'questionAnswer01 ... questionAnswer99 each parameter asks a question and gets a reply. You provide a long string to the parameter consisting of several fields (substrings) separated by vertical bars | or linefeeds, CHAR(10), like this:\nquestionAnswer01     nickname|question|points1|answer1|points2|answer2 ...\nThe fileds are:\nnickname is concatenated with "-" and conditionName to become the column title in the results CSV file. The nickname cannot be empty. The compiler issues a fatal error if it\'s empty.\nquestion is presented to the participant.\npoints is a floating number indicating the utility associated with the immediately following answer. If omitted it defaults to zero.\nanswer is a text string. The points are not seen by the participant, but the points of the selected answer are reported in results.\n\nThe vertical bars work well with left-to-right languages, like English, but are confusing with right-to-left languages, like Arabic. The problem is that mixing the left-to-right | with right-to-left text produces confusing text layout changes as you type. [Using a right-to-left separator would not cope well with translation, e.g. from English to Arabic, unless the separator was replaced as well.] So we also support using a linefeed as the separator. The linefeeds puts each field on a new line, regardless of text direction. The first separator, from the beginning of the text your study spreadsheet provides to questionAnswer, can be either | or linefeed, but the rest (in that cell) must be the same separator. Thus, if you like, you can use | as the separator and include linefeeds in your text.\n\nYou provide zero or several answers, each with an optional points. When a points is omitted, the separators (bars or linefeeds) remain. The default points is zero. This allows you to give partial credit for not-quite-right answers. Assign pointss as you please, but they must be numeric. When only one of the answers is correct, you might assign points 1 to the correct answer and let the rest be zero.\nAWAKE|You are?||asleep|1|awake\n\nThe nickname cannot be empty and is used solely to name the two columns (nickname-conditionName and nickname-conditionName.points) of responses in the saved data. The nickname and question are required; the allowed answers (each with optional points) are optional. points has zero default. If no answers are provided, then the question will accept a free-form text answer from the participant. If multiple answers are provided, then they are offered to the participant as multiple-choice alternatives, a button devoted to each one. Use questionAnswerShuffleAnswersBool to shuffle the order of the answers. You can use questionAnswerLayout to arrange the answers in a row, rather than the column default. points are not revealed to the participant. Specifying just one answer is currently an error, but this may change in a future enhancement. [We might use the single-answer field to specify type of the single answer type, e.g. logical, numerical, integer, text.]\n\nHISTORY. questionAnswer is new and replaces the old, and now-deprecated, questionAndAnswer, which had a different syntax. \n\nquestionAndAnswer is supported for only these cases:\n1. targetTask is empty (the default)\n2. targetTask===identify AND targetKind===image\n3. In the future, we’ll add further cases, as needed.\nThe compiler will soon enforce this.\nEasyEyes supports questionAnswer01 ... questionAnswer99, i.e. you can have up to 99 questions in one condition. The questions you use must start with the ending 01 and cannot skip numbers.  Any number of conditions can each have up to 99 questions. [We should, but I don\'t know whether we currently support having several questionAnswer conditions in one block.] The parameters questionAnswerShuffleQuestionsBool and questionAnswerShuffleAnswersBool allow you to randomize the order of questions and the order of answers within a condition.\n\nEXAMPLES\nFREE-FORM: Provide just a nickname and a question, no answer. For example, \nDESCRIPTION|What is your impression of the painting?\nThe participant is invited to type their answer into a text box.\nMULTIPLE CHOICE: Provide a nickname, a question, and at least two possible answers (each may have a value). The participant must click on one of the answers. For example:\nFRUIT|Which of the following is a fruit?|0|house|0|sky|1|apple|0|father|0|country\nBEAUTY|How much beauty do you get from this image right now?||1||2||3||4||5||6||7\nor\nKIND|What kind of image is it?||figurative painting||abstract painting||photograph\n\nLANGUAGE AND ALIGNMENT. If fontDirection (the text direction of the language) is left-to-right (ltr) then each question and its answers (whether in a row or column) is left aligned, otherwise it is right-aligned.\n\nOUTPUT. EasyEyes will produce two columns for each question: NICKNAME and NICKNAME.value, where NICKNAME stands for the nickname provided to QuestionAnswer. The NICKNAME column records what the participant typed or selected. The NICKNAME.value column reports its value. WHen there is no answer then there is no NICKNAME.value column.\n\nUSE THESE PARAMETERS TO SET OPTIONS\nquestionAnswerLayout (default "vertical") if "horizontal" then lay out the several answers in a row. If "vertical" then lay them out in a column.\nquestionAnswerShuffleAnswersBool (default TRUE) if TRUE then randomize order of answers for each question.\nquestionAnswerShuffleQuestionsBool (default FALSE) if TRUE then randomize the order of the questions in this condition.\n\nCOMBINE WITH showImage\nYou can combine showImage with questionAnswer. Use showImageSpareFraction to determine what fraction of the screen to reserve for the text. Use showImageWhere to determine how to divide up the screen into image and text. \n\nAlso see:\ntargetImageFolder\ntargetImageSpareFraction\ntargetImageWhere\nshowImageSpareFraction\nshowImageWhere',
    example: "AFTERLIFE|No|Is there life after death?|Yes|No|Maybe",
  },
  questionAnswerLayout: {
    ...
    default: "vertical",
    explanation:
      '🕑 questionAnswerLayout (default vertical) modifies questionAnswer. If "horizontal" then lay out the several answers horizontally in a row, guided by fontDirection. If "vertical", then vertically in a column, top to bottom.',
    example: "",
  ...
  readingCorpus: {
    name: "readingCorpus",
    availability: "the-phantom-tollbooth.txt",
    type: "text",
    default: "",
    explanation:
      '⭑ readingCorpus (default is empty) is the complete filename (with extension) of a text file (must be separately uploaded to Pavlovia). The text file should be a word list or story or book\'s worth of readable text. We typically use one of the ten IReST stories, each about 100 words long, and available in dozens of languages. They are closely matched in difficulty across stories and languages. The corpus words can be used in order or randomly, as specified by other parameters.\n     After EasyEyes reads in the corpus text, it does two analyses to facilitate its use.\n1. CONCORDANCE. Prepare a concordance. This is a two-column table. The first column is a unique list of all the corpus words. The second column is frequency, i.e. the number of times that the word appears in the corpus. For this purpose we should ignore capitalization and leading and trailing punctuation. The table is sorted by decreasing frequency.\n2. WORD INDEX. Use a regex search to make a one-column  list of the index, in the corpus, of every word. For this purpose, a word consists of an alphanumeric character plus all leading and trailing non-whitespace characters.\n⚠️️ IMPORTANT: Currently, leaving the readingCorpus field blank causes a fatal error in EasyEyes when that condition runs. We plan to add a compiler check to detect the problem at compile time, before your study runs.\n\nFIX LOOSE COMMAS IN CORPORA. We found that we were displaying some imperfect corpora with loose commas, each preceded by a space. A loose comma is treated as a word by the line-breaking algorithm, occasionally resulting in a comma at the beginning of a line. Participants are confused by seeing a comma at the beginning of a line. A space before a comma is not allowed in most languages (at least English, Arabic, Urdu, and Persian), so we filter the text, replacing every instance of " ," with ",". ',
    example: "the-phantom-tollbooth.txt",
  },
  readingCorpusCleanupPunctuation: {
    name: "readingCorpusCleanupPunctuation",
    availability: "",
    type: "text",
    default: "",
    explanation:
      'readingCorpusCleanupPunctuation (default empty) cleans punctuation in the corpus specified by readingCorpus. It processes each character (ASCII and unicode ok) in its value string in order. For each character (for example, "," or "،"), it performs a global search and replace, removing any preceding space. Thus every occurrence of " ," is replaced with ",", and every occurrence of " ،" is replaced with "،". If you want multiple passes for a character, simply repeat that character in the value string.\n\nThis option is intended to fix corpora containing loose punctuation, where punctuation is incorrectly preceded by a space. Such spacing is not permitted in normal typography for English, Arabic, Urdu, Persian, and many other languages. Because the punctuation becomes a separate token, line-breaking algorithms may place it at the beginning of a line, producing confusing text. This option removes the unwanted spaces before the specified punctuation characters.\n\nNati Tsegaye implemented readingCorpusCleanupPunctuation. He recommends setting it to\n,.;:!?،؛؟۔…',
    example: "",
  },
  ...
  readingFirstFewWords: {
    ...
    availability: "It was a dark and stormy night",
    type: "text",
    default: "",
    explanation:
  ...
  readingPages: {
    ...
    default: "-1",
    explanation:
      "⭑ readingPages (default -1) is the number of pages to be read. \nIf readingPages=-1, then EasyEyes will keep showing pages until the end of readingCorpus is reached.\nIf readingPages≥0, the compiler requires that the corpus contain at least \n(pages-0.9)*lineLength*linesPerPage\ncharacters.\n\nSetting readingCorpusEndlessBool=TRUE is incompatible with setting readingPages=-1;  the compiler will issue a fatal error.\n\nThe CSV file reports the number of characters and number of seconds for each page.\n\nAt runtime, line breaking between words (without hyphenation) makes each line, on average, about half a word shorter than the specified line length. Word length varies greatly across languages (e.g. typically 1 or 2 characters in Chinese and 4.5 in English), so, for simplicity, the compiler doesn't try to estimate the shortening of line length by line breaking.",
    example: "4",
  },
  readingSetSize: {
    name: "readingSetSize",
  ...
  responseSpokenToExperimenterBool: {
    ...
    default: "FALSE",
    explanation:
      "If responseSpokenToExperimenterBool=TRUE (default FALSE) and targetKind=rsvpReading then an studyer sits next to the child participant. The child sees the RSVP stimulus and reads the words aloud. The studyer scores the child’s report of each target word as right or wrong. This is done discreetly, so as not to discourage the child. \n\nThe studyer listens to the child, and uses the keyboard to score each word. Once the child finishes speaking, the studyer should tap the SHIFT key to  initiate scoring. Each target word will be presented for scoring. Once scored, it is replaced by the next unscored word, until there are none left to show. Then the studyer can proceed to the next trial. \n\nThe response screen shows one tiny circle per word (e.g. three).  For each word,  the studyer uses the up-arrow key for “right”, making the circle green, or the down-arrow key for “wrong”, making the circle pink. The studyer makes one keypress per word. There’s no way to go back or change the answers.",
    example: "",
  },
  responseTimeoutSec: {
  ...
  rsvpReadingSTTIgnoreOrderBool: {
    name: "rsvpReadingSTTIgnoreOrderBool",
    availability: "",
    type: "boolean",
    default: "TRUE",
    explanation:
      "rsvpReadingSTTIgnoreOrderBool (default TRUE) Ignore word order when scoring accuracy of the spoken relative to the displayed words. The published literature mostly ignores order.",
    example: "",
  },
  rsvpReadingSTTMaxSec: {
    name: "rsvpReadingSTTMaxSec",
    availability: "",
    type: "numerical",
    default: "5",
    explanation:
      "rsvpReadingSTTMaxSec (default 5) Sets a maximum waiting time for the provider's transcript, once EasyEyes has sent the audio to the provider. This is a safety limit; normally the provider responds much sooner. If no transcript arrives in time, EasyEyes treats the trial as invalid and repeats it, with fresh stimuli.",
    example: "",
  },
  rsvpReadingSTTProvider: {
    name: "rsvpReadingSTTProvider",
    availability: "",
    type: "categorical",
    default: "elevenlabs",
    explanation:
      "rsvpReadingSTTProvider (default elevenlabs) lets the experimenter choose the realtime speech-to-text (STT) provider for each RSVP condition. Allowed values:\n• elevenlabs\n• deepgram",
    example: "",
    categories: ["elevenlabs", "deepgram."],
  },
  rsvpReadingSTTUseKeytermsBool: {
    name: "rsvpReadingSTTUseKeytermsBool",
    availability: "",
    type: "boolean",
    default: "TRUE",
    explanation:
      "rsvpReadingSTTUseKeytermsBool (default TRUE) If TRUE, then, for each trial, EasyEyes sends the (typically three) displayed target words for that trial to the STT provider as \"keyterms\". This biases recognition toward those words if the speech is acoustically close to them, but it does not restrict the provider's output to those three words. If the speech cannot be recognized, then the STT indicates that nothing was transcribed.\n\nElevenLabs describes keyterms as words or phrases used to “bias the model towards transcribing them”, while still using context to decide how to transcribe the speech. A spoken word is not automatically replaced by the most similar target word. The STT can still return another word outside the three targets. If a spoken word is outside the keyterm list, the STT transcription may return another word, not a keyterm. \nHere are the providers' own explanations of how keyterms work:\nElevenLabs: https://elevenlabs.io/docs/eleven-api/guides/how-to/speech-to-text/batch/keyterm-prompting?utm_source=chatgpt.com\nDeepgram: https://developers.deepgram.com/docs/keyterm?utm_source=chatgpt.com",
    example: "",
  },
  rsvpReadingSpeechTimeoutSec: {
    name: "rsvpReadingSpeechTimeoutSec",
    availability: "",
    type: "numerical",
    default: "2",
    explanation:
      "rsvpReadingSpeechMaxBeyondSec (default 2??) Maximum duration of recording beyond the final RSVP word.\nWhen should EasyEyes decide that the participant has finished responding to the trial?\nEasyEyes uses provider speech/silence detection. Recording starts at the beginning of the RSVP presentation, and the provider finds the end by detecting a pause in speech. ElevenLabs supports VAD-based automatic commits and has a default silence threshold of 1.5 s. Deepgram similarly uses VAD/endpointing and lets us configure the required silence duration.\nI currently use about 1.5 s of silence. If an endpoint happens while the RSVP words are still being displayed, it's ignored, and EasyEyes keeps recording. \nAfter the final word, we could end the response in any of these ways:\n\nthe provider detects sufficient silence;\nthe participant presses a Finish button or key;\na maximum response timeout is reached.  ( what I intended from this parameter )\nMy suggestion is to use all three. Then rsvpReadingSpeechTimeoutSec would mean:\nMaximum time after the final RSVP word for the participant to finish responding.\nFor example, with a default of 3 s, we normally proceed earlier as soon as the provider detects the end of speech; the 3 s is only the maximum safety limit.\nWould you prefer this combined approach, or would you rather have the participant explicitly press a key/button to end every spoken response? (edited)",
    example: "",
  },
  ...
  screenshotBool: {
    ...
    default: "FALSE",
    explanation:
      '🕑 screenshotBool requests saving a full-screen screenshot of each stimulus and response display of this condition, plus each instruction display of the block. (Currently all instruction displays belong to the block, not to any condition.) Each filename should be E.B.C.TA.png, where E stands for the study name, B stands for the block number, C stands for the condition number, T stands for the trial number of the condition in the block, and A is "s" for stimulus or "r" for response. If the display is instructional then A is "i", C is 0, and T is a counter that starts at 1 at the beginning of the block. screenshotBool is condition-specific, but if several conditions enable it, EasyEyes still saves only one copy of each instructional screen. Screenshots are useful for debugging and to show the stimuli in talks and papers. It is expected that taking screenshots will severely degrade timing, so it should not be requested while a participant is being tested in earnest. Instead the scientist will test herself (or use simulateParticipantBool) to collect the images she needs.\n     Can we save these files to a "Screenshots" folder in the participant computer\'s Downloads folder or in the study repository on Pavlovia? ',
    example: "TRUE",
  },
  setResolution: {
    name: "setResolution",
  ...
  showCounterBool: {
    ...
    default: "TRUE",
    explanation:
      '⭑ showCounterBool. If TRUE, display something like,"Trial 31 of 120. Block 2 of 3. At 32 cm." (The trailing part about distance is included only if showViewingDistanceBool is TRUE.) The trial counter counts all trials in the block, which may have several conditions. If the block has three conditions with 40 blocks each, then there are 120 trials in the block. \n\nblockGroups change the block order, and conditionEnabledBool disables a block, so the block number sequence may have gaps and non-monotonicities. Thus the block number display is not, strictly speaking, a "counter". No participant has ever reported to me that they noticed any deviations from monotonic increase of block number. If the participant\'s possible awareness of these manipulations of the block sequence is a concern, set showViewingDistanceBool=FALSE.',
    example: "TRUE",
  },
  showCounterLocation: {
    name: "showCounterLocation",
    availability: "bottomRight",
    type: "categorical",
    default: "bottomRight",
    explanation:
  ...
  showParameters: {
    ...
    default: "",
    explanation:
      "🕑 showParameters (no default) accepts a comma-separated list of parameter names. Its display is in the style of showTargetSpecsBool, but it allows the scientist to specify which parameters to display. All the parameters are displayed left-aligned at the left edge of the screen, bottom-aligned, one per row, each with its value. At the moment, we only allow input parameters, but we will extend this list to include internal parameters.",
    example: "",
    categories: [""],
  },
  ...
  showProgressBarBool: {
    ...
    default: "FALSE",
    explanation:
      '⭑ showProgressBarBool (default FALSE) was originally meant for children, but everyone likes it. When TRUE, EasyEyes displays a vertical green bar that tracks the trial count for the study. The outline goes from bottom to top of the screen and it gradually fills up with green liquid, empty at zero trials, and filled to the top after the last trial of the study. Sometimes we tell the child that the green liquid is "spaceship fuel for Jamie the astronaut".\n\nIn the future we should allow specification of which side of the screen it appears on. Right now, it appears on the left edge. If there\'s only one side offered, I suspect that should be the right side.',
    example: "TRUE",
  },
  showStudyNameBool: {
    name: "showStudyNameBool",
    availability: "FALSE",
    type: "boolean",
    default: "FALSE",
    explanation:
      "🕑 showstudyNameBool (default FALSE) is useful when making screenshots to show the studyName (i.e. the name of the Pavlovia repository, e.g. crowding3). It should go in the lower left corner. We have several text messages that stack up there. If all four are present, then showText on top, above showConditionNameBool, above showstudyNameBool, above showTargetSpecsBool.",
    example: "FALSE",
  },
  showTakeABreakCreditBool: {
    ...
    default: "FALSE",
    explanation:
      "showTakeABreakCreditBool (default FALSE). MANY PARTICIPANTS REPORT LIKING THIS. Intended for long blocks, over 50 trials. Participants seem to spontaneously pause betwen blocks to catch their breath and blink their eyes, but they don't do it within a long block, and they may complain that they feel stressed and that their eyes hurt (they sting because they didn't blink during the block, which dries out the cornea), so we added this feature to force a break every so often. If showTakeABreakCreditBool then display the value of takeABreakCredit as a graphical icon next to the trial counter. A black box that gradually fills, from the bottom up, with glowing green. Empty for zero and full for 1. The box is currently centered at bottom of screen, but we plan to make it contiguous to the trial counter display.\nAlso see takeABreakMinimumDurationSec and takeABreakTrialCredit.",
    example: "TRUE",
  },
  showTargetSpecsBool: {
  ...
  takeABreakMinimumDurationSec: {
    ...
    default: "2",
    explanation:
      "takeABreakMinimumDurationSec (default 2). The minimum duration when EasyEyes takes a break. The main purpose of the break is to blink, so 2 sec is enough. It's important to remind participants to blink because when they are trying hard to see a target they often stop blinking. Without blinks the cornea may dry, which causes a burning sensation. Regularly reminding the participant to blnk avoids this discomfort.\nAlso see takeABreakTrialCredit and showTakeABreakBool.",
    example: "2",
  },
  ...
  targetImageReplacementBool: {
    ...
    default: "FALSE",
    explanation:
      'targetImageReplacementBool (default FALSE) selects whether the per-trial target image is drawn from the targetImageFolder with or without replacement, when targetKind==image. "Without replacement" considers all the trials of this condition of this block; other conditions and blocks are independent.\n\nFALSE. Sample without replacement. On each trial the target is drawn at random from the images in the targetImageFolder that have not yet been used as a target in this condition of this block, and that image is then marked as used. Thus, within a condition, no image is shown as a target more than once. This requires the folder to contain at least as many images as conditionTrials; otherwise the EasyEyes compiler reports an error.\n\nTRUE. Sample with replacement. On each trial the target is drawn at random from the whole targetImageFolder (optionally narrowed by targetImageExclude), independently of earlier trials, so the same image can recur. The folder may hold fewer images than conditionTrials.\n\nNOTE: This parameter controls only the target image. The selection of foils for an identification task is governed separately by targetImageFoilsExclude and responseMaxOptions.  targetImageReplacementBool decides reuse within this condition/block, while targetImageExclude additionally excludes images already used as targets (or targets and foils) by any condition in this session.',
    example: "",
  },
  targetImageSpareFraction: {
    name: "targetImageSpareFraction",
    availability: "",
    type: "numerical",
    default: "0",
    explanation:
      "targetImageSpareFraction (default 0) what fraction of the screen area is spared for another use (eg questionAndAnswer). I'm guessing that with questionAndAnswer we'll typically devote 0.3 to the text.\n\nWhen targetImageSpareFraction>0:\nDuration is unlimited; wait for all questions to be answered.\nUse targetImageSpareFraction and targetImageWhere to divide the screen into two sections: the target section and the spare section. Treat the target section as a new screen. Fixation will typically be in the middle of it. Don’t shrink anything. Use all spatial parameters as usual, with the smaller screen.",
    example: "",
  },
  targetImageWhere: {
    name: "targetImageWhere",
    availability: "",
    type: "categorical",
    default: "top",
    explanation:
      "targetImageWhere (default top) determines which part of the screen gets the target image. It can be left, right, top, or bottom. If it’s left or right then the screen will have left and right parts. If it’s top or bottom then the screen will have top and bottom parts. This has no effect when targetImageSpareFraction=0.",
    example: "",
    categories: ["top", "right", "bottom", "left"],
  },
  targetKind: {
  ...
  targetNBorderCharacter: {
    ...
    default: "",
    explanation:
      '🕑 targetNBorderCharacter (default empty). Concatenated at each end of the targetN string. Typically “X” or empty. Used for span studys. Avoid the SPACE character " ", as it may create problems in measuring string length to control center-to-letter letter spacing. \nAlso see targetN, targetNMax, targetNPlaceholderCharacter.',
    example: "",
  },
  targetNMax: {
    name: "targetNMax",
    ...
    default: "10",
    explanation:
      "🕑 targetNMax (default 10). The maximum allowed string length (not counting border characters). Used for span studys. Also see targetN, targetNBorderCharacter, targetNPlaceholderCharacter.",
    example:
      "targetNMax (new) The maximum allowed string length. Typically 10.",
  },
  ...
  targetSizeDeg: {
    ...
    default: "2",
    explanation:
      "targetSizeDeg (default 2) sets target size. Ignored unless needed. Size is either height or width, as specified by targetSizeIsHeightBool. Height and width are based on the union of the bounding boxes of all the letters in fontCharacterSet. In the union, all characters have the same baseline vertically, and are centered horizontally.",
    example: "5",
  },
  ...
  thresholdParameterScaleUp: {
    ...
    availability: "thresholdParameterScaleUp",
    type: "numerical",
    default: "1.05",
    explanation:
  ...
  thresholdParameterScaleUpMore: {
    ...
    availability: "thresholdParameterScaleUpMore",
    type: "numerical",
    default: "1.2",
    explanation:
  ...
  x_calibrateDistanceAllowedRatio: {
    name: "x_calibrateDistanceAllowedRatio",
    availability: "calibrateDistanceAllowedRatio",
    type: "obsolete",
    default: "",
    explanation: "❌ Use _calibrateDistanceAllowedRatioFOverWidth instead.",
    example: "calibrateDistanceAllowedRatio",
  },
  x_calibrateSoundCopyToDownloadsBool: {
    name: "x_calibrateSoundCopyToDownloadsBool",
    availability: "",
    type: "obsolete",
    default: "FALSE",
    explanation:
